...
if(isset($_REQUEST['codigo_estudante']) && isset($_FILES['file'])){
    ...
    if(isset($_FILES["file"])){
        ...
        $target_dir = "arquivos/trabalhos"; //create folder files/ to save file
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $filePath)) {
            ...
            if(Trabalho::actualizar($_REQUEST['codigo_estudante'], 'codigo_estudante', array('ficheiro' => $filePath, 'estado'=>3))){
