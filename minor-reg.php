	...
	if(Token::check(Input::get('token'))){
		...
		if($validation->passed()){
			...
			try{
                ...
                if(!Minor::cadastrar(array(
                    'id_curso' => Input::get('curso'),
                    'designacao_minor' => Input::get('designacao_minor'),
				...
				Redirect::to('minor-reg.php?success='.$success);
...
<body>
	...
	<main class="main">
		...
		<form class="card" method="POST">
			<h3>Registar Minor</h3>
			<?php
            if(isset($_REQUEST['success'])){
                if($_REQUEST['success'] == "false"){
                ?>
                <label>Minor Registado com successo</label>
                <?php
                }else{
			...
			<div class="row">
				<div class="column">
					<div class="form-floating mb-3">
						<input type="text" name="designacao_minor" class="form-control" id="floatingInput" placeholder="Designacao do minor">
